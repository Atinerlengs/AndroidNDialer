...
public class VideoSessionController implements InCallPresenter.InCallStateListener,
    ...
    private class AutoDeclineTimer {
        ...
        public void startTiming() {
            ...
            mCountdownSeconds = getDefaultCountDownTimer(mInCallPresenter.getContext());
    ...
    private int getDefaultCountDownTimer(Context context) {
        Log.d(this, "getDefaultCountDownTimer");
        ...
        int subId = telephonyManager.getSubIdForPhoneAccount(
                    telecomManager.getPhoneAccount(mPrimaryCall.getAccountHandle()));
        ...
        if (configMgr != null) {
            ...
            if (b != null) {
                defaultCountDownTimer = b.getInt(CarrierConfigManager
                        .KEY_VIDEO_UPGRADE_REQUEST_DECLINE_TIMER);
            }
        }
        Log.d(this, "getDefaultCountDownTimer: " + defaultCountDownTimer);
