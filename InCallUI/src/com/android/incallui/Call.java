...
public class Call {
        ...
        new android.telecom.Call.Callback() {
            ...
            public void onVideoCallChanged(android.telecom.Call call,
                ...
                Log.d(this, "TelecomCallCallback onStateChanged call=" + call + " videoCall="
                        + videoCall);
                /// M: for clear session modification state after SRVCC.when SRVCC happens before the
                ///user responses to upgrade to video request,the user will can't success to
                ...
                ///null after SRVCC. @{
                if (videoCall == null && mSessionModificationState ==
                        Call.SessionModificationState.RECEIVED_UPGRADE_TO_VIDEO_REQUEST) {
                    Log.d(this, "clear session modification");
    ...
    public int getState() {
         ...
         * outgoing-call had been triggered. So user would see dialing status or dialing animation
         * from call-ui.
         * In order to avoid this error case, if a call had the capability
         * "CAPABILITY_DISCONNECT_FROM_CONFERENCE" and property "PROPERTY_VOLTE", it should be
         * regarded as a conference children call.
         *
         * @{
         */
        if (mTelecomCall != null && (mTelecomCall.getParent() != null ||
                can(android.telecom.Call.Details.CAPABILITY_DISCONNECT_FROM_CONFERENCE) &&
