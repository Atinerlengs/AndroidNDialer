...
public class InCallCameraManager {
    ...
    private void maybeInitializeCameraList(Context context) {
        ...
        try {
            ...
            /// M: log enhancement.
            Log.e(this, "Could not access camera: "+e);
        ...
        mIsInitialized = true;
        /// M: log enhancement
        Log.v(this, "initializeCameraList : done, facing="
                + mFrontFacingCameraId + ", back=" + mRearFacingCameraId);
    }
