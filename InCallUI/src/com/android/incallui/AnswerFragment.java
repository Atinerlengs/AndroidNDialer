...
public abstract class AnswerFragment extends BaseFragment<AnswerPresenter, AnswerPresenter.AnswerUi>
   ...
   /**
    ...
    public void initSmartController(final Context context) {
        if (mSmartAnswerccessibility == null) {
            mSmartAnswerccessibility = new FreemeCallAccessibility(context,
    ...
    public void destroySmartController() {
        if (mSmartAnswerccessibility != null) {
    ...
    //*/ freeme.zhaozehong, 20171028. for freemeOS, call back when Visibility status Changed
    public void onVisibilityChanged(boolean isShow){
        // do nothing, subclass implementation
    }
    //*/
}
