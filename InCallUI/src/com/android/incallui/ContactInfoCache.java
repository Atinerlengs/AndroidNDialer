...
public class ContactInfoCache implements ContactsAsyncHelper.OnImageLoadCompleteListener {
    ...
    public Drawable getDefaultContactPhotoDrawable() {
        if (mDefaultContactPhotoDrawable == null) {
            mDefaultContactPhotoDrawable =
                    /*/ freeme.zhaozehong, 25/07/17. for freemeOS, reset default avatar
                    mContext.getResources().getDrawable(R.drawable.img_no_image_automirrored);
                    /*/
                    mContext.getResources().getDrawable(R.drawable.freeme_incoming_call_default_photo);
                    //*/
        }
    ...
    //*/ freeme.zhaozehong, 20/07/17. save/get contact photo
    private Drawable photo;

    public Drawable getContactPhotoDrawable() {
        return photo;
    }

    public void setContactPhotoDrawable(Drawable photo) {
        this.photo = photo;
    }
    //*/
}
