...
public class CallButtonPresenter extends Presenter<CallButtonPresenter.CallButtonUi>
    ...
    private void updateButtonsState(Call call) {
        ...
        */
        ...
        /// M: add other feature. @{
        /*/ freeme.zhaozehong, 20170920. for freemeOS, hide mtk buttons
        ...
        ui.showButton(BUTTON_HANGUP_ACTIVE_AND_ANSWER_WAITING, false);
        ui.enableButton(BUTTON_HANGUP_ACTIVE_AND_ANSWER_WAITING, false);
        //*/
        /// @}

        ui.updateButtonStates();

        //*/ freeme.zhaozehong, 28/07/17. for freemeOS
        ui.updateButtonStates(isVideo,
                call.hasProperty(android.telecom.Call.Details.PROPERTY_GENERIC_CONFERENCE));
        //*/
    }
    ...
    public interface CallButtonUi extends Ui {
        ...
        //*/ freeme.zhaozehong, 28/07/17. for freemeOS
        void updateButtonStates(boolean isVideo, boolean isConference);
        //*/
        Context getContext();
