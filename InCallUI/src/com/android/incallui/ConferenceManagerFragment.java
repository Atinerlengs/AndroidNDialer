...
//*/ freeme.zhaozehong, 20171028. for NavigationBar overlay views
...
public class ConferenceManagerFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*/ freeme.zhaozehong, 20170804. for freemeOS
        final View parent =
                inflater.inflate(R.layout.conference_manager_fragment, container, false);
        /*/
        final View parent = inflater.inflate(R.layout.freeme_conference_manager_fragment,
                container, false);
        //*/
        ...
        /*/ freeme.zhaozehong, 20171028. for freemeOS, remove elevation
        mActionBarElevation =
        ...
        //*/ freeme.zhaozehong, 20171027. navgationbar overlaps the button
        manageConferencePanel = parent.findViewById(R.id.manageConferencePanel);
        initNavBarUtils();
        //*/
    ...
    //*/ freeme.zhaozehong, 20171027. navgationbar overlaps the button
    private View manageConferencePanel;
    ...
    private void updateNavgationBar(boolean isShow, int navHeight) {
        if (manageConferencePanel != null) {
            manageConferencePanel.setPadding(
                    manageConferencePanel.getPaddingLeft(),
                    manageConferencePanel.getPaddingTop(),
                    manageConferencePanel.getPaddingRight(),
                    isShow ? navHeight : 0);
        }
    }
    ...
    public void onVisibilityChanged(boolean isVisible) {
        ...
        //*/ freeme.zhaozehong, 20171028. reset actionBar background color
        if (actionBar != null) {
            int color = isVisible ? getResources().getColor(R.color.freeme_color_primary)
                    : Color.TRANSPARENT;
