...
public class InCallPresenter implements CallList.Listener,
    ...
    private void attemptFinishActivity() {
        ...
        if (doFinish) {
            ...
            if (mAccountSelectionCancelled) {
                ...
                /*/ freeme.zhaozehong, 20170801. keep activity animation when finish
    ...
    public void onDisconnect(Call call) {
        ...
        if (isActivityStarted()) {
            mInCallActivity.recordNumerToDialpad();
        }
        //*/
    ...
    public void onCircularRevealComplete(FragmentManager fm) {
        Log.d(this, "onCircularRevealComplete");
        if (mInCallActivity != null) {
    ...
    public AnswerPresenter getAnswerPresenterByFreeme() {
        return getAnswerPresenter();
    }
    //*/
