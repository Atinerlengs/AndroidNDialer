...
public class SmartDialNumberListAdapter extends DialerPhoneNumberListAdapter {
    ...
    public SmartDialNumberListAdapter(Context context) {
        super(context);
        //*/ freeme.zhaozehong, 20170804. for freemeOS, get Context
        mContext = context;
        //*/
    ...
    public Uri getDataUri(int position) {
        ...
        if (cursor != null) {
            ...
            if (DialerFeatureOptions.isDialerSearchEnabled()) {
                ...
                /*/ freeme.zhaozehong, 2017085. for freemeOS
                if (id < 0) {
                /*/
                if (id <= 0) {
                //*/
    ...
    public void setQueryString(String queryString) {
        ...
        //*/ freeme.zhaozehong, 20171117. to refresh shortcut item
        boolean isContacts = isContact(queryString);
        changed |= setShortcutEnabled(SHORTCUT_CREATE_NEW_CONTACT, !isContacts && showNumberShortcuts);
        changed |= setShortcutEnabled(SHORTCUT_ADD_TO_EXISTING_CONTACT, !isContacts && showNumberShortcuts);
        /*/
