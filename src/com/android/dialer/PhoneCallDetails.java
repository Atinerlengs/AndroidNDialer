...
public class PhoneCallDetails {
    ...
    //*/ freeme.zhaozehong, 03/07/17. for PhoneCallDetails external data
    public boolean mIsYellowPage;
    public int simId;
    public void setDetailsEx(int isYellowPage, int simid) {
        mIsYellowPage = isYellowPage == 1;
        simId = simid;
    }
    //*/
}
