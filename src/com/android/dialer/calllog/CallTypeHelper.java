...
public class CallTypeHelper {
    ...
    public CallTypeHelper(Resources resources) {
        ...
        /*/ freeme.zhangjunjian, 17-7-14,add for history call
        mIncomingName = resources.getString(R.string.type_incoming);
        mOutgoingName = resources.getString(R.string.type_outgoing);
        /*/
        mIncomingName = resources.getString(R.string.freeme_call_type_incoming);
        mOutgoingName = resources.getString(R.string.freeme_call_type_outgoing);
        //*/
