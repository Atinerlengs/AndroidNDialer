...
public class CallLogAdapter extends GroupingListAdapter
    ...
    private int mCalllogsFilter;

    public void setCalllogsFilter(int calllogsFilter) {
        mCalllogsFilter = calllogsFilter;
    }
    //*/
    ...
    private final View.OnClickListener mExpandCollapseListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            /*/ freeme.zhaozehong, 03/07/17. FreemeOS, call directly
    ...
    private ViewHolder createCallLogEntryViewHolder(ViewGroup parent) {
        ...
        /*/ freeme.zhaozehong, 03/07/17. for freemeOS, use custom layout
    ...
    protected void bindCallLogListViewHolder(ViewHolder viewHolder, int position) {
        ...
        //*/ freeme.zhaozehong, 03/07/17. set PhoneCallDetails external data
        final int isYellowPage = c.getInt(CallLogQuery.IS_FREEME_YELLOW_PAGE);
        details.setDetailsEx(isYellowPage, c.getInt(CallLogQuery.SIM_IDX));
        //*/
        ...
        //*/ freeme.zhangjunjian, 17-7-28, add for call log
        views.callLogsFilter = mCalllogsFilter;
        //*/
        views.info = info;
        ...
        if (currentGroup != previousGroup) {
            /*/ freeme.zhaozehong, 03/07/17. FreemeOS, always gone
        ...
        views.updatePhoto();
        //*/ freeme.zhaozehong, 03/07/17. show freeme yellow page data
        if (details.mIsYellowPage) {
            new FreemeYellowPageUtils().showFreemeYellowPageNameAndLogo(mContext, info.number,
                    views.quickContactView, views.phoneCallDetailsViews.nameView);
        }
        //*/
