...
import com.freeme.dialer.calllog.FreemeCallLogDetailActivity;
//*/
...
public abstract class IntentProvider {
    ...
    //*/ freeme.zhangjunjian, 17-7-28, for freemeOS
    public static IntentProvider getCallDetailIntentProvider(final String[] callNumbers,
                                                             final long[] callIds,
                                                             final boolean isConferenceCall,
                                                             final int calllogsFilter) {
        return new IntentProvider() {
            @Override
            public Intent getIntent(Context context) {
                Intent intent = new Intent(context, FreemeCallLogDetailActivity.class);
                intent.putExtra(FreemeCallLogDetailActivity.EXTRA_PHONE_NUMBERS, callNumbers);
                intent.putExtra(FreemeCallLogDetailActivity.EXTRA_CALL_LOG_IDS, callIds);
                intent.putExtra(FreemeCallLogDetailActivity.EXTRA_IS_CONFERENCE_CALL, isConferenceCall);
                intent.putExtra(FreemeCallLogDetailActivity.EXTRA_CALL_LOG_TYPE_FILTER, calllogsFilter);
                return intent;
            }
        };
    }
