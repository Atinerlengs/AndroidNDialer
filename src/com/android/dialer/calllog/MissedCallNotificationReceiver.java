...
public class MissedCallNotificationReceiver extends BroadcastReceiver {
    ...
    //*/freeme.zhangjunjian, 20171016. add missed call sim
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        /*/
        int sim = intent.getIntExtra(EXTRA_NOTIFICATION_SIM_SLOT, -1);
        CallLogNotificationsService.updateMissedCallNotifications(context, count, number, sim);
        //*/
