    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        */
        ...
        if (DialerFeatureOptions.IP_PREFIX && !TextUtils.isEmpty(details.ipPrefix)
            ...
            if (details.ipPrefix.length() > 8) {
                buffer.append(details.ipPrefix.substring(0, 5));
                buffer.append("...");
            } else {
                buffer.append(details.ipPrefix);
            }
        ...
        if (Calls.VOICEMAIL_TYPE == callType || CallTypeHelper.isMissedCallType(callType)) {
            ...
            durationView.setText(callTypeString + " " + FreemeDateTimeUtils.getDurations(details.duration));
        }
        //*/

        //*/ freeme.zhaozehong, 20170731. for freemeOS
        ImageView sim_card_status = (ImageView) result.findViewById(R.id.sim_card_status);
        if (sim_card_status != null) {
            if (details.simId == -1 || details.simId == 0) {
