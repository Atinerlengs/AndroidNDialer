...
public class CallLogNotificationsService extends IntentService {
    ...
    public static final String EXTRA_MISSED_CALL_COUNT =
            "MISSED_CALL_COUNT";
    //*/freeme.zhangjunjian, 20171016. add missed call simid;
    public static final String EXTRA_NOTIFICATION_SIM_SLOT = "EXTRA_CALL_SIM_SLOT";
    //*/
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        switch (action) {
            ...
            case ACTION_UPDATE_MISSED_CALL_NOTIFICATIONS:
                ...
                //*/freeme.zhangjunjian, 20171016. add missed call simid;
                int slot = intent.getIntExtra(EXTRA_NOTIFICATION_SIM_SLOT, -1);
                MissedCallNotifier.getInstance(this).updateMissedCallNotification(count, number, slot);
                /*/
    ...
    //*/freeme.zhangjunjian, 20171016. add missed call simid;
    public static void updateMissedCallNotifications(Context context, int count,
                                                     String number, int slot) {
        Intent serviceIntent = new Intent(context, CallLogNotificationsService.class);
        serviceIntent.setAction(
                CallLogNotificationsService.ACTION_UPDATE_MISSED_CALL_NOTIFICATIONS);
        serviceIntent.putExtra(EXTRA_MISSED_CALL_COUNT, count);
        serviceIntent.putExtra(EXTRA_MISSED_CALL_NUMBER, number);
        serviceIntent.putExtra(EXTRA_NOTIFICATION_SIM_SLOT, slot);
        context.startService(serviceIntent);
    }
    //*/
}
