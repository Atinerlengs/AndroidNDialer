...
public class ContactInfoHelper {
    ...
    private ContactInfo createPhoneLookupContactInfo(Cursor phoneLookupCursor, String lookupKey) {
        ...
        /// M: @{
        info.contactSimId = phoneLookupCursor.getInt(PhoneQuery.INDICATE_SIM);
        info.isSdnContact = phoneLookupCursor.getInt(PhoneQuery.IS_SDN);
        /// @}
        return info;
    }
    ...
    public static ContactInfo getContactInfo(Cursor c) {
        ...
        info.contactSimId = c.getInt(CallLogQuery.CONTACT_SIM_INDICATE);
        info.isSdnContact = c.getInt(CallLogQuery.IS_SDN_CONTACT);
        /// @}
