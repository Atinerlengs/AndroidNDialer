...
//*/ freeme.zhaozehong, 14/07/17. for freemeOS, add other settings
import com.freeme.dialer.settings.FreemePhoneOtherSetting;
//*/
...
public class DialerSettingsActivity extends AppCompatPreferenceActivity {
    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        //*/freeme.zhangjunjian,create 2017-06-20 for phone other setting
        Header otherSettingsHeader = new Header();
        otherSettingsHeader.titleRes = R.string.freeme_phone_setting;
        otherSettingsHeader.fragment = FreemePhoneOtherSetting.class.getName();
