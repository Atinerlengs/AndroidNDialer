...
public class CallDetailActivity extends NeedTestActivity
    ...
    private CallLogAsyncTaskListener mCallLogAsyncTaskListener = new CallLogAsyncTaskListener() {
        ...
        public void onGetCallDetails(PhoneCallDetails[] details) {
            ...
            if (!TextUtils.isEmpty(mDetails.getPreferredName())) {
                ...
                mCallerNumber.setText(TextUtils.isEmpty(callLocationOrType) ? displayNumberStr
                        : (callLocationOrType + " " + displayNumberStr));
            } else {
        ...
        private CharSequence getNumberTypeOrLocation(PhoneCallDetails details) {
            if (!TextUtils.isEmpty(details.namePrimary)) {
                ...
                if (details.numberType == Phone.TYPE_CUSTOM && TextUtils
                    ...
                    return Phone.getTypeLabel(mContext, details.numberType,
                            details.numberLabel);
                }
                /// @}
            } else {
    ...
    private Uri[] getCallLogEntryUris() {
        ...
        if (ExtensionManager.getInstance().getCallLogExtension()
                    .getCallLogEntryUris(getIntent(), uris)) {
            return uris;
        }
        /// @}
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /*/ freeme.zhaozehong, 29/06/17. for freemeOS 7.2
        deleteMenuItem.setIcon(R.drawable.ic_delete_24dp);
        /*/
        deleteMenuItem.setIcon(R.drawable.freeme_call_logs_delete_icon);
        //*/
    ...
    public boolean onMenuItemClick(MenuItem item) {
        if (item.getItemId() == R.id.call_detail_delete_menu_item) {
            ...
            /// M: for Op01 Plug-in about callog CDD @{
            if (ExtensionManager.getInstance().getCallLogExtension()
                    .deleteCallItems(this, "", mCallLogAsyncTaskListener)) {
                return true;
            }
            /// @}
