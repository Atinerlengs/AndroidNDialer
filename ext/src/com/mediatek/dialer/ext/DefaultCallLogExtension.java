...
//        Log.d(TAG, msg + " default");
  ...
  /**
    ...
    */
    ...
    /**
     * for OP01
     * Change the intent content in OP01Plugin
     * @param Intent     intent
     * @param int           type
     */
    @Override
    public void changeIntentContent(Intent intent, int type) {

    }

    /**
     * for OP01
     * Get call log entry id from OP01
     * @param Intent     intent
     * @param Uri[]           uris
     * @return true when enter reject call detail in op01
     */
    @Override
    public boolean getCallLogEntryUris(Intent intent, Uri[] uris) {
        return false;
    }

    /**
     * for OP01
     * fetch call reject from provider in OP01Plugin
     * @param Object     object
     * @param int           type
     * @param String[]   projection
     * @return true when query reject calls from op01
     */
    @Override
    public boolean fetchCallLogs(Object obj, int type,
            long newerThan, String accountId, String[] projection) {
        return false;
    }

    /**
     * for OP01
     * delete call reject from provider in OP01Plugin
     * @param Activity     activity
     * @param String       string
     * @param Object      obj
     * @return true  when delete reject call items in op01
     */
    @Override
    public boolean deleteCallItems(Activity activity, String string, Object obj) {
        return false;
    }

    /**
     * for OP01
     * delete all call reject items from provider in OP01Plugin
     */
    @Override
    public void deleteAllCallItems() {
    }

    /**
     * for OP01
     * check if need to refresh calllog fragment in OP01Plugin
     * @return need refresh in op01
     */
    @Override
